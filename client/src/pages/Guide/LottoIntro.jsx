...
export default function LottoIntro() {
        ...
        <ul style={{ paddingLeft: 20, marginTop: 8 }}>
          ...
          <li>
            ...
            <a
              ...
              style={{ color: "#7a0e0e", textDecoration: "underline" }}
            >
              동행복권 공식 홈페이지
            </a>
          </li>
  ...
  const [page, setPage] = useState(1); // 클론 포함 시작
  ...
  return (
    <div style={PAGE}>
      <div style={INNER}>
        ...
        <p style={{ margin: "3px 0px 0px", color: "#7f1d1d", fontSize: 13 }}>
      ...
      <div style={containerStyle}>
          ...
          <div style={{ flex: 1, overflow: "hidden", position: "relative" }}>
            ...
            >
              {extendedPages.map((pg, pIdx) => (
                <div
                  key={pIdx}
                  style={{ flex: "0 0 100%", display: "flex", gap: 32, alignItems: "stretch" }}
                >
                  {pg.map((card, cIdx) => (
                    <div
                      key={cIdx}
          ...
          {Array.from({ length: pageCount }).map((_, i) => (
            <span
              ...
              style={{
                ...
                borderRadius: "50%",
                margin: "-3px 4px",
                background: i === realPage ? "#7a0e0e" : "#ccc"
              }}
            />
          ))}
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginTop: 10 }}>
          ...
          >
            <div style={titleStyle}>🔗 유용한 로또 링크</div>
            <div style={contentStyle}>
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <tbody>
                  <tr style={{ borderBottom: "1px solid #f3d7d7" }}>
                    <td style={{ padding: "12px 10px", width: "70%" }}>
                  ...
                  <tr style={{ borderBottom: "1px solid #f3d7d7" }}>
                    ...
                    <td style={{ padding: "12px 10px", textAlign: "right" }}>
                      <a
                        href="https://dhlottery.co.kr/gameInfo.do?method=statHistory"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{
                          color: "#7a0e0e",
                  ...
                  <tr style={{ borderBottom: "1px solid #f3d7d7" }}>
                    ...
                    <td style={{ padding: "12px 10px", textAlign: "right" }}>
                      <a
                        href="https://dhlottery.co.kr/gameResult.do?method=lotTv"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{
                          color: "#7a0e0e",
                  ...
                  <tr style={{ borderBottom: "1px solid #f3d7d7" }}>
                    ...
                    <td style={{ padding: "12px 10px", textAlign: "right" }}>
                      <a
                        href="https://dhlottery.co.kr/gameResult.do?method=highWin"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{
                          color: "#7a0e0e",
