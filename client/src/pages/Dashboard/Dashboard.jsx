...
import compareImg from "../../assets/image/9.png";
      ...
      <div style={INNER}>
        ...
        <div style={ROWS}>
          ...
          <div style={GRID3}>
            ...
            <div style={CARD}>
              <div style={TITLE}>회차별 분석 결과 비교</div>
              <p style={{ color: "#7a6a6a", marginTop: 0, marginBottom: 12 }}>
                두 회차간의 분석 결과를 비교해보세요.
              </p>
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => navigate("/compare/compare")}
                  style={{
                    position: "absolute",
                    top: "18%",     // ← 막대 왼쪽 대각선 위에 맞춰 조정
                    left: "50%",    // ← 좌표 조절
                    transform: "translate(-50%, -50%)",
                    padding: "10px 16px",
                    borderRadius: 12,
