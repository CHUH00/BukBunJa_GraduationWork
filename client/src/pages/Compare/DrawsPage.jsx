    ...
    return (
        <div style={PAGE}>
            <div style={INNER}>
                ...
                <p style={{ margin:"3px 0px 10px 0px", color:"#7f1d1d", fontSize:13 }}>
                ...
                <div style={ROWS}>
                    <div style={CARD}>
                        ...
                        {selected && (
                            <>
                                <h2 style={{ marginBottom: 55, textAlign: "center" }}>
                                    <span style={{ color: "#7a0e0e", fontSize: 35 }}>{selected.draw_number}회차 </span> 
                                    <span style={{ fontSize: 35 }}>로또 6/45 당첨 결과</span><br></br>
                                    <span style={{fontSize: 20, color: "#666" }}>
                                        ({selected.draw_date} 추첨)
                                    </span>
                                </h2>

                                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 55, justifyContent: "center" }}>
                                    {selected.numbers.map((n, i) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                height: 70,
                                                borderRadius: "50%",
                                                background: n >= 1 && n <= 10 ? "#fbc400" : n <= 20 ? "#69c8f2" : n <= 30 ? "#ff7272" : n <= 40 ? "#aaaaaa" : "#b0d840",
                                                display: "flex",
                                                alignItems: "center",
                                    ...
                                    <span style={{ margin: "0 6px", fontSize: 35 }}>+</span>
                                    <div
                                        style={{
                                            width: 70,
                                            height: 70,
                                            borderRadius: "50%",
                                            background: selected.bonus_number >= 1 && selected.bonus_number <= 10 ? "#fbc400" : selected.bonus_number <= 20 ? "#69c8f2" : selected.bonus_number <= 30 ? "#ff7272" : selected.bonus_number <= 40 ? "#aaaaaa" : "#b0d840",
                                            display: "flex",
                                            alignItems: "center",
                                            justifyContent: "center",
                                            color: "white",
